...
namespace InkEraseSelect
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        // アプリバーで消去と選択ができるように手を加えています
        void OnEraceChecked(object sender, RoutedEventArgs args)
        {
            selectAppBarButton.IsChecked = false;
            inkManager.Mode = InkManipulationMode.Erasing;
        }
        void OnSelectChecked(object sender, RoutedEventArgs args)
        {
            eraseAppBarButton.IsChecked = false;
            inkManager.Mode = InkManipulationMode.Selecting;
        }
        void OnUnChecked(object sender, RoutedEventArgs args)
        {
            inkManager.Mode = InkManipulationMode.Inking;
        }
    }
