...
namespace FingerPaint
{
    public sealed partial class MainPage : Page
    {
        ...
        async void OnDataTransferDataRequested(DataTransferManager sender, DataRequestedEventArgs args)
        {
            ...
            RandomAccessStreamReference reference = await GetBitmapStream(image);
        ...
        async void OnCopyAppBarButtonClick(object sender, RoutedEventArgs args)
        {
            ...
            dataPackage.SetBitmap(await GetBitmapStream(image));
        ...
        async Task<RandomAccessStreamReference> GetBitmapStream(Image image)
        {
            // WritableBitmapから RenderTargetBitmapへ書き換え
